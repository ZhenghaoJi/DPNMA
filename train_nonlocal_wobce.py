...
from models_nonlocal import Model
...
parser.add_argument('--epoch', default=1500, type=int, help='train epochs')
...
parser.add_argument('--load', default=0, type=int, help='load checkpoint')
...
for epoch in range(start_epoch, start_epoch + args.epoch):
    ...
    for i, (images, density, att) in enumerate(train_loader):
        ...
        print("Epoch:{}, Step:{}, Loss:{:.4f} {:.4f}".format(epoch, i, loss_avg / (i + 1), loss_avg / (i + 1)))
    ...
    with torch.no_grad():
        ...
        mse /= len(test_loader)
        mse = mse ** 0.5
        print('Epoch:', epoch, 'MAE:', mae, 'MSE:', mse,'BESTMAE:', best_mae)
